...
# As the pagination is dynamic, it shows buttons redirecting to the first and last page and only ten pages at once. Thus, for instance, choosing page_number 1250 whilst being at page 25 would end in error since the attribute "a href" with javascript::..., `Page$1250` is not definied in the td class at page number 25
